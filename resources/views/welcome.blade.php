...
<!-- Mirrored from html.webinane.com/food-chow/index.html by HTTrack Website Copier/3.x [XR&CO'2013], Wed, 30 Oct 2019 08:56:03 GMT -->
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="" />
    <meta name="keywords" content="" />
    <title>Заказать еду по Ташкенту</title>
...
<main>
        ...
        <div class="topbar">
            <div class="container">
                ...
                <div class="topbar-register">
                    <a class="log-popup-btn" href="{{ url('/login') }}" title="Login">LOGIN</a> /
                    <a class="sign-popup-btn" href="{{ url('/register') }}" title="Register" itemprop="url">REGISTER</a>
                </div>
                <div class="social1">
                                ...
                                <li class="wow bounceIn" data-wow-delay="0.2s">
                                    <div class="top-restaurant">
                                        <a class="brd-rd50" href="#" title="Restaurant 1" itemprop="url">
                                            <img src="/image/{{ $brand->image }}" alt="{{ $brand->name }}" itemprop="image">
                                        </a>
                                    </div>
                                </li>
                                @endforeach
                            ...
                            <div class="col-md-4 col-sm-6 col-lg-4">
                                <div class="popular-dish-box wow fadeIn" data-wow-delay="0.2s">
                                    <div class="popular-dish-thumb">
                                        <a href="food-detail.html" title="" itemprop="url"><img src="/image/{{ $post->image }}" alt="popular-dish-img1.jpg" itemprop="image"></a>
                                    ...
                                    <div class="popular-dish-info">
                                        ...
                                        <p itemprop="description">{!!$brand->detail!!} </p>
                                ...
                                <div class="col-md-6 col-sm-12 col-lg-6">
                                    <div class="featured-restaurant-gallery">
                                        ...
                                        <div class="featured-restaurant-box">
                                            <div class="featured-restaurant-thumb">
                                                <a class="red-bg brd-rd2" data-fancybox href="../../vimeo.com/49674259.html" title="Click To Play" itemprop="url"><i class="fa fa-play"></i></a>
    ...
    <div class="bottom-bar dark-bg text-center">
        <div class="container">
            <p itemprop="description">&copy; 2018 <a class="red-clr" href="../../webinane.com/index.html" title="Webinane" itemprop="url" target="_blank">WEBINANE</a>. All Rights Reserved</p>
        </div>
    </div><!-- Bottom Bar -->
...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
        ...
        <div class="container">
            <div class="row">
                <div class="img">
                    <img src="{{ asset('image/product/product.jpg') }}" alt="">
                </div>
            </div>
        </div>
    </body>
